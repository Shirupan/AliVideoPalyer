 ...
 * @date 2019-06-06
 */
public class SmVcResizeTextureView extends TextureView {
    protected static final String TAG = "JCResizeTextureView";

    // x as width, y as height
    protected Point mVideoSize;

    public SmVcResizeTextureView(Context context) {
        super(context);
        init();
    }

    public SmVcResizeTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        SmLogger.i("resize TextureView: width[" + width + "],height[" + height+"]");
