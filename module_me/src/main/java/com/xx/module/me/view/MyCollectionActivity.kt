 ...
 *@date 2019-06-13
 */
@Path(RouterUrl.ACTIVITY_ME_COLLECTION)
class MyCollectionActivity : BaseActivity<BasePresenter<IBaseView>>() {
    ...
    private fun initViewPager() {
        ...
        navigator.adapter = object : CommonNavigatorAdapter() {
            ...
            override fun getTitleView(context: Context, index: Int): IPagerTitleView {
                ...
                titleView.setPadding(titleView.paddingLeft, titleView.paddingTop, titleView.paddingRight, ScreenUtils.dip2px(context, 5f))
        ...
        mViewPager.adapter = object : FragmentStatePagerAdapter(supportFragmentManager) {
            override fun getItem(position: Int): Fragment {
                return MyCollectionFragment.getInstance(position)
            }
